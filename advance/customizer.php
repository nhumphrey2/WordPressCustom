	...
	switch( $option['type'] ) {
		...
		case 'wp_dropdown_albums':
			...
			if ($r->have_posts()) :
				...
				$args['choices'][0] = esc_html__( 'There are no albums yet!', 'rife' );
		...
		case 'wp_dropdown_works':
			...
			if ($r->have_posts()) :
				...
				$args['choices'][0] = esc_html__( 'There are no works yet!', 'rife' );
...
function apollo13framework_customizer_controls_js(){
	...
	$human_variants = array(
		'100' => esc_html__( 'thin', 'rife' ),
		'200' => esc_html__( 'extra-light', 'rife' ),
		'300' => esc_html__( 'light', 'rife' ),
		'400' => esc_html__( 'regular', 'rife' ),
		'500' => esc_html__( 'medium', 'rife' ),
		'600' => esc_html__( 'semi-bold', 'rife' ),
		'700' => esc_html__( 'bold', 'rife' ),
		'800' => esc_html__( 'extra-bold', 'rife' ),
		'900' => esc_html__( 'black', 'rife' ),
	);
