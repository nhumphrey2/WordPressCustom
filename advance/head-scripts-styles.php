...
if(!function_exists('apollo13framework_js_parameters')){
	...
	function apollo13framework_js_parameters(){
        ...
        $params = array(
	        ...
	        /* MISC */
            'load_more'                 => esc_html__( 'Load more', 'rife' ),
            'loading_items'             => esc_html__( 'Loading next items', 'rife' ),
        ...
        if($proofing){
            ...
            $params['proofing_add_comment']         = esc_html__( 'Add comment', 'rife' );
            $params['proofing_comment_placeholder'] = esc_html__( 'Write your comment here&hellip;', 'rife' );
            $params['proofing_mark_item']           = esc_html__( 'Mark item', 'rife' );
            $params['proofing_uncheck_item']        = esc_html__( 'Uncheck item', 'rife' );
