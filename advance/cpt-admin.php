...
function apollo13framework_admin_gallery_item_html($item_class, $img_class, $src, $file_name = false ){
	...
	<div class="<?php echo esc_attr($item_class); ?>">
		...
		<span class="mu-item-edit fa fa-pencil" title="<?php esc_attr_e( 'Edit', 'rife' ); ?>"></span>
		<span class="mu-item-remove fa fa-times" title="<?php esc_attr_e( 'Remove item', 'rife' ); ?>"></span>
