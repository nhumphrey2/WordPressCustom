...
if(!function_exists('apollo13framework_password_form')){
    ...
    function apollo13framework_password_form() {
        ...
        return
            ...
            <p class="inputs"><input name="post_password" type="password" size="20" placeholder="' . esc_attr__( 'password', 'rife' ) . '" /><input type="submit" name="Submit" value="' . esc_attr__( 'Submit', 'rife' ) . '" /></p>
            </form>
            ';
    }
}
