    ...
    echo '<div class="notice notice-warning inline"><p>' .
         sprintf(
             wp_kses(
                 ...
                 __( 'Theme options for this page can be found in <a href="%s">Appearance -&gt; Customize -&gt; Blog settings</a>.', 'rife-free' ),
                 array(
                     'a'      => array(
                         'href' => array()
                     )
...
function apollo13framework__no_meta_shop_page_notice() {
    echo '<div class="notice notice-warning inline"><p>' .
         sprintf(
             wp_kses(
                 /* translators: %s: link to customizer */
                 __( 'Theme options for this page can be found in <a href="%s">Appearance -&gt; Customize -&gt; Shop(WooCommerce) settings</a>.', 'rife-free' ),
                 array(
                     'a'      => array(
                         'href' => array()
                     )
...
function apollo13framework__no_meta_albums_page_notice() {
    echo '<div class="notice notice-warning inline"><p>' .
         sprintf(
             wp_kses(
                 /* translators: %s: link to customizer */
                 __( 'Theme options for this page can be found in <a href="%s">Appearance -&gt; Customize -&gt; Albums settings</a>.', 'rife-free' ),
                 array(
                     'a'      => array(
                         'href' => array()
                     )
...
function apollo13framework__no_meta_works_page_notice() {
    echo '<div class="notice notice-warning inline"><p>' .
         sprintf(
             wp_kses(
                 /* translators: %s: link to customizer */
                 __( 'Theme options for this page can be found in <a href="%s">Appearance -&gt; Customize -&gt; Works settings</a>.', 'rife-free' ),
                 array(
                     'a'      => array(
                         'href' => array()
                     )
            ...
            */
            ...
            elseif ( $meta['type'] === 'multi-upload' ) { ?>
                ...
                <div class="a13-mu-container">
                    ...
                    <label class="button button-large"><input type="checkbox" id="mu-prepend" value="1" /><?php esc_html_e( 'Add items at beginning of list', 'rife-free' ); ?>
                    </label>
                    ...
                    <p class="inline-part disabled" id="a13_multi_tags">
                        <label for="a13-bulk-tagging"><?php esc_html_e( 'Add tags to selected items', 'rife-free' ); ?></label>
                        <input id="a13-bulk-tagging" class="newtag" size="16" value="" autocomplete="off" type="text" disabled="disabled" />
                        <input class="button tagadd" value="<?php esc_attr_e( 'Add', 'rife-free' ); ?>" type="button" disabled="disabled" />
                    </p>
                    <?php endif;
