...
if(!function_exists('apollo13framework_admin_head')){
    ...
    function apollo13framework_admin_head(){
        ...
        wp_enqueue_style( 'apollo-jquery-ui', get_theme_file_uri( 'css/ui-lightness/jquery-ui-1.10.4.custom.css' ), false, A13FRAMEWORK_THEME_VERSION, 'all'  );
        wp_enqueue_style( 'admin-css', get_theme_file_uri( 'css/admin-css.css' ), false, A13FRAMEWORK_THEME_VERSION, 'all' );
