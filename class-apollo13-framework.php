...
class Apollo13Framework
{
    ...
    function start()
    {
        ...
        define('A13FRAMEWORK_THEME_VERSION', '2.2.0.1');
        define('A13FRAMEWORK_THEME_VER', A13FRAMEWORK_THEME_VERSION ); //legacy - do not use
        define('A13FRAMEWORK_MIN_COMPANION_VERSION', '1.5.4');
...
//		define('A13FRAMEWORK_CUSTOM_POST_TYPE_WORK_SLUG', 'work'); //just to show it also exist - defined in real a bit lower
        ...
        //these constants are moved to Apollo13 Framework Extensions plugin(1.4.1). Will be removed from theme in future updates
        ...
        if($admin || $customizer){
            ...
            if($pagenow === 'nav-menus.php' || defined( 'DOING_AJAX' ) ){
                /** @noinspection PhpIncludeInspection */
                require_once(get_theme_file_path( 'advance/admin/mega-menu.php'));
            }
        }
