...
function apollo13framework_is_companion_plugin_ready($fail_message = false, $silent = false){
	...
	if ( empty( $plugins[$plugin_file] ) ) {
		...
		$label = __( 'Install Apollo13 Framework Extensions plugin', 'rife-free' );
	}
	...
	elseif ( is_plugin_inactive( $plugin_path ) ){
		...
		$label = __( 'Activate Apollo13 Framework Extensions plugin', 'rife-free' );
	}
	...
	elseif( version_compare( $plugins[$plugin_file]['Version'], A13FRAMEWORK_MIN_COMPANION_VERSION, '<'  ) ){
		...
		$label = __( 'Update Apollo13 Framework Extensions plugin', 'rife-free' );
	}

	if(!$ready && !$silent){
		$message = $fail_message ? $fail_message : __( 'This feature requires Apollo13 Framework Extensions plugin to be active and in proper version.', 'rife-free' );
...
function apollo13framework_apollo13_recommendations() {
	...
	<div class="tools-grid">
		...
		<div class="tool">
			<a href="<?php echo esc_url('https://kinsta.com/?kaid=XTVGRKCSNUSR'); ?>" title="<?php echo esc_html__( 'Kinsta', 'rife-free' ); ?>"><img src="<?php echo esc_url( get_theme_file_uri( 'images/tools/kinsta.png' ) ); ?>" alt="<?php echo esc_attr__( 'Kinsta', 'rife-free' ); ?>" /></a>
	...
	<p class="disclaimer"><?php echo esc_html__( 'Some of above links can be affiliates links to service that we like and use.', 'rife-free' ); ?></p>
